export function refreshMenuSections() {
  sectionBtns = document.querySelectorAll(
    ".section:not(.btn, .menu__sect-title)"
  );
}
...
export let sectionBtns = document.querySelectorAll(
  ".section:not(.btn, .menu__sect-title)"
);
...
export const addProjectCloseBtn = document.querySelector(
  "#popup_project_close_btn"
);

export const detailsTaskPopup = document.querySelector("#details_task_popup");
export const detailsTaskPopupBtn = document.querySelector(
  "#popup_details_close_btn"
);
...
export const popupProjectSelection = taskPopup.querySelector(
  '[data-select="project"]'
);
export const popupSelections = taskPopup.querySelectorAll(
  ".selection__selected"
);
export const popupInputs = {
  title: popupForm.querySelector("#popup_title"),
  desc: popupForm.querySelector("#popup_desc"),
  project: popupForm.querySelector(
    '.selection__selected[data-select="project"]'
  ),
  dueDate: popupForm.querySelector("#popup_due_date"),
  priority: popupForm.querySelector(
    '.selection__selected[data-select="priority"]'
  ),
};
